                    ...
                    <div class="container">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/admin-announcement/{{ $announcement->id }}">{{$announcement->title}}</a></li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-10 col-12">
                                    <h5 class="heading-20">Edit {{ $announcement->title }}</h5>
                                </div>
                            </div>
                        </div>
                        <hr>

                        <form action="{{ route('admin-announcement.update', ['admin_announcement' => $announcement->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                ...
                                <textarea name="content" id="content" cols="30" rows="10" class="form-control" placeholder="{{ $announcement->content }}"></textarea>
                            </div>
                        </div>

...
<div id="edit_tuition" class="block mt-20 mb-80">
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Tuition Fees Details</li>
                </ol>
            </nav>
            ...
            <h5 class="heading-20"><i class="icon-plus"></i> Edit Tuition Details </h5>
            <hr>

            {{-- Add Tuition Form --}}

            <form action="{{route('tuition.update', ['tuition' => $tuition_detail->id])}}" method="post">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="container mt-50 mb-50">
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                <label for="grade">{{ __('Grade Level') }}</label>
                        ...
                        <div class="col">
                            <div class="form-group row">
                                <label for="total_fee">{{ __('Total Fee')}}</label>

                                <div class="col">
                                <input type="text" class="form-control total_amount" name="total_fee" id="total_fee" placeholder="{{ $tuition_detail->total_due }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="tuition_fee" class="col-md-4 col-form-label text-md-right">{{ __('Tuition Fee')}}</label>

                        <div class="col-md-6">
                        <input type="number" class="form-control tuition" step="any" name="tuition_fee" id="tuition_fee" placeholder="{{ $tuition_detail->tuition_fee }}">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="misc_fee" class="col-md-4 col-form-label text-md-right">{{ __('Miscellaneous Fee')}}</label>

                        <div class="col-md-6">
                            <input type="number" class="form-control tuition" step="any" name="misc_fee" id="misc_fee" placeholder="{{ $tuition_detail->misc_fee }}">
                        </div>
                    </div>

                    <div class="form-group row  mb-50">
                        <label for="others_fee" class="col-md-4 col-form-label text-md-right">{{ __('Others Fee')}}</label>

                        <div class="col-md-6">
                            <input type="number" class="form-control tuition" step="any" name="others_fee" id="others_fee" placeholder="{{ $tuition_detail->others_fee }}">
                        </div>
                    </div>
                    <hr>
